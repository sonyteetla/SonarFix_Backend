...
public class ScanTask {
    ...
    private int originalIssueCount;   
    ...
    public int getOriginalIssueCount() { return originalIssueCount; }  // ✅
 ...
 public void setProgress(int progress) { this.progress = progress; }
    ...
    public void setTotalFixesApplied(int total) { this.totalFixesApplied = total; }

    public void setOriginalIssueCount(int count) { this.originalIssueCount = count; }  // ✅
    ...
    public void addFixReport(FixExecutionReport report) {
        if (report != null) fixReports.add(report);
    }
}