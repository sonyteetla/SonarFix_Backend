...
public class FileContentController {
        ...
        public FileContentResponse getFileContent(
                ...
                List<String> rawLines = fileContentService.getFileContent(projectKey, filePath);

                List<Issue> allIssues = scanIssueService.fetchAllIssues(projectKey, null, null, null);

                List<Issue> issuesForFile = allIssues.stream()
                ...
                for (int i = 0; i < rawLines.size(); i++) {
                        ...
                        List<Issue> lineIssues = issuesForFile.stream()
                                        .filter(issue -> issue.getStartLine() != null &&
